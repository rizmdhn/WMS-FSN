<div class="bg-light border-right" id="sidebar-wrapper">
  ...
  <div class="list-group list-group-flush">
    ...
    <a href="{{ route('report.index') }}" class="list-group-item list-group-item-action bg-light">Laporan Barang Keluar</a>
    ...
    <a href="{{ route('user.index') }}" class="list-group-item list-group-item-action bg-light">Data Pengguna</a>

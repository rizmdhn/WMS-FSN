                    ...
                    <div class="row">
                        <div class="col-md-4 pl-3 pr-3">
                            ...
                            <form action="{{ route('purchase.store') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    @if (Auth::user()->akses == 'operator')
                                        <input required class="form-control form-control-sm" type="date"
                                            name="tgl_purchase" min="<?php echo date('Y-m-d'); ?>">
                                ...
                                <div class="form-group" id="expiry" style="display: none;">
                                    <label>Expired</label>
                                    <input required class="form-control form-control-sm" type="date" name="expired"
                                        id="expired">
                                </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <div style="margin-top: 20px">
                                <a href="{{ route('purchase.update') }}" class="btn btn-success"><i
                                        class="glyphicon glyphicon-circle-arrow-right"></i> Selesai</a>
                            </div>
